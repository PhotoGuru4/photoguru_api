...
-- AddForeignKey
ALTER TABLE "concept_photos" ADD CONSTRAINT "concept_photos_concept_id_fkey" FOREIGN KEY ("concept_id") REFERENCES "concepts"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
